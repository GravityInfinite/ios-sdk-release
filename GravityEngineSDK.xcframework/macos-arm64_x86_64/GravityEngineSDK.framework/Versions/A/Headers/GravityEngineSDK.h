...
- (void)initializeGravityEngineWithClientId:(NSString *) clientId withUserName:(NSString *)userName withVersion:(int)version withIdfa:(NSString *) idfa withIdfv:(NSString *)idfv withCaidInfo:(NSString *)caid_info withSyncAttribution:(bool)syncAttribution withChannel:(NSString *)channel withAdData:(NSDictionary *)adData withSuccessCallback:(CallbackWithSuccess)successCallback withErrorCallback:(CallbackWithError)errorCallback;
...
- (void)initializeGravityEngineWithClientId:(NSString *) clientId withUserName:(NSString *)userName withVersion:(int)version withIdfa:(NSString *) idfa withIdfv:(NSString *)idfv withCaidInfo:(NSString *)caid_info withSyncAttribution:(bool)syncAttribution withCreateTime:(long)createTimestamp withCompany:(NSString *)company withChannel:(NSString *)channel withAdData:(NSDictionary *)adData withSuccessCallback:(CallbackWithSuccess)successCallback withErrorCallback:(CallbackWithError)errorCallback;
...
- (void)initializeGravityEngineWithClientId:(NSString *)client_id withCaidInfo:(NSString *)caid_info withSyncAttribution:(bool)syncAttribution withChannel:(NSString *)channel withAdData:(NSDictionary *)adData withSuccessCallback:(CallbackWithSuccess)successCallback withErrorCallback:(CallbackWithError)errorCallback;
